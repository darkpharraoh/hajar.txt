...
foreach ($keywords as $i => $keyword) {
    ...
    $sitemap_files[$sitemap_file_number] .= '    <loc>https://tgs.com.vn/videos/?en_TH=' . urlencode($keyword) . '</loc>' . "\n";
    $sitemap_files[$sitemap_file_number] .= '  </url>' . "\n";
}
...
foreach ($sitemap_files as $sitemap_file_number => $sitemap_file) {
    ...
    $sitemap_index .= '    <loc>https://tgs.com.vn/videos/sitemap-' . $sitemap_file_number . '.xml</loc>' . "\n";
    $sitemap_index .= '  </sitemap>' . "\n";
}
